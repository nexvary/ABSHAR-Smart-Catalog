...
<form class="searchbox" action="catalog.php" role="search"><input name="q" aria-label="البحث" placeholder="ابحث عن منتج، موديل أو علامة تجارية..."><button type="submit" aria-label="بحث">⌕</button></form>
...
<a class="<?=$currentPage==='catalog.php'?'active':''?>" href="catalog.php">الأقسام</a>
